...
function populateSimilarTickets() {
  ...
  if (suggestedTickets.length === 0) {
    // Generate some dummy similar tickets if none exist
    suggestedTickets = [
      {
        id: "BUG-1024",
        summary: "Similar issue with login page not loading correctly",
        status: "completed",
        urgency: "medium",
        assignee: "Jane Smith",
        assigneeInitials: "JS",
        resolutionTime: "~3h",
        description: "Users reported login page not loading correctly on mobile devices",
        tags: ["Frontend", "Auth"],
        isDead: false,
        predictedTeam: "Frontend Team",
        estimatedDuration: "~3 hours",
        classification: "Medium Priority",
        affectedArea: "Login Page",
        ...
        impactScope: "External Users",
        assignmentReason: "Experienced in frontend issues",
        environment: "Production",
        expectedBehavior: "Login page should load correctly",
        observedIssues: "Login page fails to load",
        stepsToReproduce: "1. Open login page on mobile device\n2. Observe the page loading failure",
        errorMessages: "net::ERR_CONNECTION_REFUSED",
      },
      {
        id: "BUG-987",
        ...
        assigneeInitials: "TB",
        resolutionTime: "~4h",
        description: "Password validation fails when special characters are used",
        tags: ["Backend", "Security"],
        isDead: false,
        predictedTeam: "Backend Team",
        estimatedDuration: "~4 hours",
        classification: "High Priority",
        affectedArea: "Authentication Service",
        longResolution: false,
        reportedBy: "QA Team",
        reporterDepartment: "Quality Assurance",
        reporterTeam: "QA Team Beta",
        ...
        assignmentReason: "Security expert",
        environment: "Staging",
        expectedBehavior: "Password validation should accept special characters",
        observedIssues: "Authentication fails",
        stepsToReproduce: "1. Enter password with special characters\n2. Attempt to login",
      ...
      },
      {
        ...
        assigneeInitials: "AC",
        resolutionTime: "~5h",
        description: "Application crashes immediately after loading on iOS 15 devices",
        tags: ["Mobile", "iOS"],
        isDead: false,
        predictedTeam: "Mobile Team",
        estimatedDuration: "~5 hours",
        classification: "Critical Priority",
        affectedArea: "Mobile App",
        longResolution: false,
        reportedBy: "Beta Testers",
        reporterDepartment: "Testing",
        reporterTeam: "Beta Testing Group",
        ...
        impactScope: "iOS 15 Users",
        assignmentReason: "iOS specialist",
        environment: "Production",
        expectedBehavior: "Application should load without crashing",
        observedIssues: "Application crashes on startup",
        stepsToReproduce: "1. Open application on iOS 15 device",
        errorMessages: "Application crashed",
      },
    ]
  ...
  similarTicketsContainer.innerHTML = suggestedTickets
    .map(
      (ticket) => `
    <div class="similar-ticket" onclick="openSimilarTicket('${ticket.id}')">
...
function openSimilarTicket(ticketId) {
  ...
  let ticket = suggestedTickets.find((t) => t.id === ticketId) || allTickets.find((t) => t.id === ticketId)

  if (!ticket) {
    // Create a mock ticket if not found
    ticket = {
      id: ticketId,
      summary: "Similar authentication issue",
      status: "completed",
      urgency: "medium",
      assignee: "John Doe",
      assigneeInitials: "JD",
      ...
      isDead: false,
      description: "This is a similar ticket that was resolved previously.",
      ...
      reportedBy: "Customer Support",
      reporterDepartment: "Support",
      reporterTeam: "Support Team Beta",
      reportedDate: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString(),
      dueDate: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(),
      assignedDepartment: "Engineering",
      assignedTeam: "Backend Development",
      impactScope: "External Users",
      assignmentReason: "Expert in authentication systems with proven track record.",
      environment: "Production",
    }
  }
